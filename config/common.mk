...
PRODUCT_COPY_FILES += \
    vendor/standart/config/permissions/android.software.nfc.beam.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/permissions/android.software.nfc.beam.xml
...
# Lineage SDK
#include vendor/standart/config/lineage_sdk_common.mk
#endif
...
PRODUCT_COPY_FILES += \
    vendor/standart/prebuilt/common/etc/init/init.openssh.rc:$(TARGET_COPY_OUT_PRODUCT)/etc/init/init.openssh.rc
